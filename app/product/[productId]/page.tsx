...
const ProductDetails: React.FC<ProductDetail> = () => {
    ...
    <div className="w-full  bg-white  flex justify-center py-5 rounded-[20px] mt-5">
      ...
      {ProductDetail.map((items, index) => (
          ...
          />
            ...
            <div className='mt-5'><p className='text-black opacity-[50%] size-[13px] w-full'>Support Images</p></div>
            ...
            <div className=''>
              ...
              <button className='px-[10px] py-[6px] bg-[#e8f3ff] border border-[#00000080] rounded-full text-[#0171E3] text-reponsiveText3 shadow-md shadow-[#0171E314]'>Edit Profile</button>
              </Link>
            </div>
        ...
        <div className="mt-9 w-full">
            <OrderTable activeTab={activeTab as 'all' | 'NewOrders' | 'PendingOrders' | 'SentOut' | 'Completed'} orderStatus={getOrderStatus(activeTab)}
