...
export default function SentOutTable () {
    return (
        ...
        <table className="w-full min-w-[55rem] bg-white rounded-[15px]">
            ...
            <tbody>
                {tableItems.map((items, index) => (
                     ...
                     <td className="p-3 ">
                         <div className="flex items-center gap-2">
                         <button className="py-[9px] px-[5px] bg-[#EDF6FF] rounded-[18px] text-[black] text-[11px]">Awaiting Completion</button>
                         <button className="py-[9px] px-[10px] bg-[#000000] rounded-[18px] text-[white] text-[11px]">See details</button>
                        </div>
                     </td>
                 </tr>
